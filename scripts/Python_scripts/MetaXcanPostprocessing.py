...
class MetaXcanPostprocess(object):
    ...
    def annotateMetaxcanOutput(self, projectName):
        ...
        for outputFileName in self.outputFileListWithoutSNPs:
            ...
            data.insert(2, 'tissue', outputFileName.split('/')[-1][3:])
